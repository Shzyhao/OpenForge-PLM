...
> 版本：v1.1 ｜ 状态：**已全部交付**（P1~P6 实现 PR #24~#29，冒烟修复 PR #28/#30，真实环境两轮验证）｜ 更新日期：2026-08-25
...
**交付结论**（v1.1.0）：A~F 六组 46 项中 P0/P1 全部交付（含 D9 批量启停）；E10 双令牌、B7/B8 角色复制停用、C6 权限点联动检查、F8 安全看板留待后续迭代。

**工程备忘**：网关路由清单曾三次因新增 API 前缀未登记被真实冒烟捕获（auth 域/security 域）——后续新增服务路径时同步更新 gateway application.yml，或实现 C6 式启动自检。
